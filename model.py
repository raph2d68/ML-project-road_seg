...
# This is where training samples and labels are fed to the graph.
    ...
    tf.compat.v1.summary.histogram('conv1_weights 1', tf.reshape(conv1_weights, [-1]))
    
    prinnnn = tf.reshape(conv1_weights[:,:,:,0], [1, 5, 5, 3])
    

    tf.compat.v1.summary.image('summconv_visu', prinnnn, max_outputs=3)
